...
def graph():
    ...
    # if they want a table
        ...
        if agg_func != None and agg_func != "":
            ...
            if agg_func=='count':
                if var_1 == None or var_1 == "":
                    error = 'To create a table with count aggregation, specify an x-value variable.'
                elif var_2 != "" or var_3 != "":
                    error = 'To create a table with count aggregation, only specify values for x-value.'
                elif var_1 not in categoricals:
                    error = 'To create a table with count aggregation, select a categorical x-value variable.'
                else:

...
#def gm():
    ...
    fig1.update_layout(
        title="Total Tax Amount by Role and County",
    ...
    fig2.update_layout(
        title="Count of Black Males by Role and County",
        xaxis_title="County",
    ...
    fig3.update_layout(
        title="Count of White Males by Role and County",
        xaxis_title="County",
    ...
    fig4.update_layout(
        title="Total Tax Amount by Role and Former Enslavement Status",
        xaxis_title="Role",
    ...
    fig5.update_layout(
        title="Average Total Tax Amount by Role and Former Enslavement Status",
        xaxis_title="Role",
    ...
    fig6.update_layout(
        title="Amount Taxed on Land vs. Total Tax Value by Former Enslavement Statu",
